    ...
    <div class="goods_content fl mt10 ml10">
        ...
        <div class="summary">
            ...
            <div class="preview fl">
                <div class="midpic">
                    <a href="<?=$gallerys[0]->path."?imageView2/1/w/800/h/800"?>" class="jqzoom" rel="gal1">   <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
                        <img src="<?=$gallerys[0]->path."?imageView2/1/w/350/h/350"?>" alt="" />               <!-- 第一幅图片的中图 -->
                    </a>
                </div>
                ...
                <div class="smallpic">
                    ...
                    <div class="smallpic_wrap">
                        <ul>
                            <?php foreach ($gallerys as $k=>$v):?>
                            <li <?=$k==0?'class="cur"':''?>>
                                <a <?=$k==0?'class="zoomThumbActive"':''?> href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: '<?=$v->path."?imageView2/1/w/350/h/350"?>',largeimage: '<?=$v->path."?imageView2/1/w/800/h/800"?>'}"><img src="<?=$v->path."?imageView2/1/w/50/h/50"?>"></a>
                            </li>
                            <?php endforeach;?>
                        </ul>
                    </div>
            ...
            <div class="goodsinfo fl ml10">
                ...
                <form action="<?=\yii\helpers\Url::to(['home/add-cart'])?>" method="get" class="choose">
                    <ul>
                ...
                <div class="introduce detail_div none">
                    <div class="attr mt15">
                        <ul>
                            ...
                            <li><span>上架时间：</span><?=date("Y-m-d H:i:s",$good->create_at)?></li>
                            <li><span>商品分类：</span><?=$category->name?></li>
