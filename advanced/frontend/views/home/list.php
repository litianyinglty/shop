...
<div class="list w1210 bc mt10">
    ...
    <div class="breadcrumb">
        <h2>当前位置：<?=\yii\helpers\Html::a("首页",['home/index'])?> > <a href="">电脑、办公</a></h2>
    </div>
    <!-- 面包屑导航 end -->
    <!-- 左侧内容 start -->
        ...
        <div class="filter mt10">
            ...
            <div class="filter_wrap">
                <dl>
                    ...
                    <?php foreach (\backend\models\Brand::find()->all() as $brand):?>
                    <dd><?=\yii\helpers\Html::a($brand->name,['home/index','id'=>$brand->id])?></dd>
                    <?php endforeach;?>
...
<!--                    <dd><a href="">富士通（Fujitsu）</a></dd>-->
                ...
                <dl>
                    <dt>价格：</dt>
                    <dd class="cur"><a href="">不限</a></dd>
                    <?php foreach (\backend\models\Goods::find()->all() as $good):?>
                    <dd><?=\yii\helpers\Html::a($good->shop_price.'--'.$good->market_price)?></dd>
                    <?php endforeach;?>
...
<!--                </dl>-->
                ...
                <dl class="last">
                    <dt>分类：</dt>
                    <dd class="cur"><a href="">不限</a></dd>
                    <?php foreach (\backend\models\GoodsCategory::find()->where(['!=','parent_id','0'])->all() as $cate):?>
                    <dd><?=\yii\helpers\Html::a($cate->name,['home/index','id'=>$cate->id])?></dd>
                    <?php endforeach;?>
...
<!--                    <dd><a href="">其它intel平台</a></dd>-->
        ...
        <div class="goodslist mt10">
            <ul>
                ...
                <li>
                    <dl>
                        <dt><?=\yii\helpers\Html::a(\yii\helpers\Html::img($good->logo),['detail','id'=>$good->id])?></dt>
                        <dd><?=\yii\helpers\Html::a($good->name,['detail','id'=>$good->id])?></dt>
