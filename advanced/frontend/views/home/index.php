    ...
    <div class="guide_content fl">
        ...
        <div class="guide_wrap">
            ...
            <div class="recommend none">
                <ul>
                    <?php foreach (\backend\models\Goods::find()->where(['status'=>1])->all() as $good):?>
                    <li>
                        <dl>
                            <dt><?=\yii\helpers\Html::a(\yii\helpers\Html::img($good->logo),['home/list','id'=>$good->id])?></dt>
                            <dd><?=$good->name?></dd>
...
<div class="floor1 floor w1210 bc mt10">
    ...
    <div class="floor_left fl">
        ...
        <div class="cate fl">
            ...
            <div class="cate_wrap">
                <ul>
                    <?php foreach (\backend\models\GoodsCategory::find()->all() as $cate):?>
                    <li><?=\yii\helpers\Html::a($cate->name,['home/list','id'=>$cate->id])?></li>
                    <?php endforeach;?>
            ...
            <div class="goodslist_wrap">
                <div>
                    <ul>
                        ...
                        <li>
                            <dl>
                                <dt><?=\yii\helpers\Html::a(\yii\helpers\Html::img($good->logo),['home/detail','id'=>$good->id])?></dt>
                                <dd><?=\yii\helpers\Html::a($good->name,['home/detail'])?></dd>
                                <dd><span>售价：</span> <strong><?=$good->shop_price?></strong></dd>
                            </dl>
                        </li>
                        <?php endforeach;?>
