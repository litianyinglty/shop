...
<div class="success w990 bc mt15">
    ...
    <div class="success_bd">
        <p><img src="<?=\yii\helpers\Url::to(['order/pay','orderId'=>$orderId])?>" /></p>
        <p><span></span>订单提交成功，我们将及时为您处理</p>

        <p class="message">完成支付后，你可以 <?=\yii\helpers\Html::a("查看订单状态",['order/list'],['orderId'=>$orderId])?>  <a href="">继续购物</a> <a href="">问题反馈</a></p>
    </div>
</div>
<!-- 主体部分 end -->
