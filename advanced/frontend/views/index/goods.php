...
$good=\backend\models\Goods::findOne($id);
$cate=\backend\models\GoodsCategory::findOne(['id'=>$good->category_id]);
$goodsIntro=\backend\models\GoodsIntro::findOne(['goods_id'=>$good->id]);
...
<div class="main w1210 mt10 bc">
    ...
    <div class="breadcrumb">
        <h2>当前位置：<?=\yii\helpers\Html::a('首页',['index/index'])?> > <?=\yii\helpers\Html::a($cate->name,['index/list'])?>>> <?=$good->name?></h2>
    </div>
    <!-- 面包屑导航 end -->
    ...
    <div class="goods_left fl">
        ...
        <div class="related_cat leftbar mt10">
            ...
            <div class="leftbar_wrap">
                <ul>
                    <?php
                    $brands=\backend\models\Brand::find()->all();
                    foreach ($brands as $brand){
                        echo '<li>'.\yii\helpers\Html::a($brand->name,['index/list']).'</li>';
                    }
                    ?>
                </ul>
            </div>
    ...
    <div class="goods_content fl mt10 ml10">
        ...
        <div class="summary">
            ...
            <div class="preview fl">
                <div class="midpic">
                    <?=\yii\helpers\Html::img($good->logo,['width'=>'350px','height'=>'350px'])?>;
                </div>
                ...
                <div class="smallpic">
                    ...
                    <div class="smallpic_wrap">
                        <ul>
                            <?php
                            $id=Yii::$app->request->get('id');
                            $images=\backend\models\GoodsGallery::find()->where(['goods_id'=>$id])->all();
                            foreach ($images as $image){
                            echo '<li class="cur">';
                            echo \yii\helpers\Html::img($image->path);
                            echo '</li>';
                            }
                            ?>
                ...
                <div class="introduce detail_div none">
                    <div class="attr mt15">
                        <ul>
                            ...
                            <li><span>商品库存：</span><?=$good->stock?></li>
                            <li><span>商品状态：</span><?php if($good->status=='1'){echo "上线";}else{echo "下线";}?></li>
                            <li><span>商品排序：</span><?=$good->sort?></li>
