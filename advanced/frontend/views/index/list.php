...
$brand=\backend\models\Brand::findOne($brandId);
$good=\backend\models\Goods::findOne(['brand_id'=>$brand->id]);
...
<div class="list w1210 bc mt10">
    ...
    <div class="breadcrumb">
        <h2>当前位置：<?=\yii\helpers\Html::a('首页',['index/index'])?> > <?=$cate->name?></h2>
    </div>
    <!-- 面包屑导航 end -->
            ...
            <div class="filter_wrap">
                <dl>
                    ...
                    foreach ($brands as $brand)
                        echo '<dd>'.\yii\helpers\Html::a($brand->name).'</dd>';
                    ?>
<!--                    <dd class="cur"><a href="">不限</a></dd>-->
...
<!--                    <dd><a href="">富士通（Fujitsu）</a></dd>-->
                ...
                <dl>
                    ...
                    foreach ($goods as $good){
                        echo '<dd>'.\yii\helpers\Html::a($good->shop_price.'—'.$good->market_price).'</dd>';
                    }
                    ?>
...
<!--                    <dd><a href="">7000-7999</a></dd>-->
                ...
                <dl>
                    ...
                    <dd class="cur"><a href="">不限</a></dd>
                    <?php
                    $cates=\backend\models\GoodsCategory::find()->all();
                    foreach ($cates as $cate){
                        echo '<dd>'.\yii\helpers\Html::a($cate->name).'</dd>';
                    }
                    ?>
